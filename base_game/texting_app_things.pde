   ...
   class ContactState implements ProcedureState {
     ...
     void draw(Game g) {
      ...
      if(message.indexOf("#") != -1) {
        message = message.substring(0, message.indexOf("#")) + allies.get(0) + message.substring(message.indexOf("#")+1);
      }
      else if(message.indexOf("~") != -1) {
        message = message.substring(0, message.indexOf("~")) + traitors.get(0) + message.substring(message.indexOf("~")+1);
      }
